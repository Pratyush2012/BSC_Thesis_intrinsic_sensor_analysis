...
the spirit of \cite[\S6.4]{Blanke2016}. The detector consumes only the
...
Following Problem~6.6 of \cite{Blanke2016}, let
...
\end{equation}
Following the recursive CUSUM in \S6.4.2 of \cite{Blanke2016}, the decision
...
to zero (the reinitialisation step of Algorithm~6.3 in \citet{Blanke2016}).
...
\cite{Blanke2016} directly. Treating the standardised IMU feature vector
