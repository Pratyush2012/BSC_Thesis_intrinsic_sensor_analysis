...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Pictures/Figures/confusion_matrix_xgboost_all_C5.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Pictures/Figures/confusion_matrix_svm_aggregated.png}
