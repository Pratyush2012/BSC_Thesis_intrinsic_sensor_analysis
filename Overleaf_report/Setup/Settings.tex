...
%\colorlet{frontbackcolor}{dtupurple} % Set the background colour of the front- and back page. Choose the colour so it matches the main colour of front page picture
...
dtured,         fill=dtured,        \\%
blue,           fill=dtublue,          \\%
navyblue,       fill=dtunavy       \\%
yellow,         fill=dtuyellow         \\%
orange,         fill=dtuorange         \\%
green,          fill=dtugreen           \\%
purple,         fill=dtupurple         \\%
}
...
\titleformat{\chapter}[display]{\Huge}{\relsize{3} \color{dtured}\thechapter}{1em}{\bfseries\raggedright}[\vspace{-10mm} \rule{\textwidth}{1pt}]
